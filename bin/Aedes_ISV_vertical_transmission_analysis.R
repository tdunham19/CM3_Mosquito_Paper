...
plot_output_dir   <- paste0(output_dir, "/figures/")
...
# output model results in table to screen
...
make_one_big_plot <- function(Parent1 = "Poza Rica", 
  ...
  # save as PDF
  plot_filename <- paste0(plot_output_dir, Parent1, "_×_", Parent2, "_", Virus, "_without_full_annotation.pdf")
  ggsave(filename = plot_filename, plot = big_p,  width=10, height=7.5, units="in")
