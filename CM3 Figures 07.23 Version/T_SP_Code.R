...
# Starting Prevalence Phasi

df <- read_excel("T_SP_Phasi.xlsx")
...
ggsave("T SP Phasi.pdf", height=8, width=8, units="in")


# Starting Prevalence GMV

df <- read_excel("T_SP_GMV.xlsx")
...
ggsave("T SP GMV.pdf", height=8, width=8, units="in")
