...
myColors3 <- c("#999999", "#999999", "#999999", "#999999", "#999999", "#999999", "#D55E00", "#999999", "#999999",
               "#CC66FF", "#990000", "#999999", "#336699")
...
ggplot(us_and_mexico_map, aes(x = long, y = lat)) +
  ...
  geom_point(data = CM3_meta_data, aes(x = Long, y = Lat, fill=State, colour = State), color="black", shape=21, size=3, alpha=0.90, stroke=0.2) + 
  geom_text_repel(data = CM3_meta_data, size = 3, aes(label = State, x = Long, y = Lat)) +
  coord_map(xlim=xlim, ylim=ylim) + fillScale + theme(axis.text.x=element_blank(),
                                                      axis.text.y=element_blank(),
                                                      legend.text=element_text(family ="Helvetica", size=10),
                                                      axis.ticks=element_blank(),
